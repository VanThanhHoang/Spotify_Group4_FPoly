...
public class UserPlayListFragmentPresenter {
    ...
    public void addSongToPlayList(int playListId, int songId) {
        Call<Void> insertSongToUserPlayList = ApiSkyMusic.apiSkyMusic.add_song_to_play_list(playListId, songId);
        insertSongToUserPlayList.enqueue(new Callback<Void>() {
            @Override
            public void onResponse(Call<Void> call, Response<Void> response) {
                Log.d("123", "rs " + response.body());
            }
